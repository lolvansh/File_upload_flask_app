            ...
            <div className="flex gap-4 justify-between">
                ...
                <button 
                    ...
                    className="bg-blue-600 text-white font-semibold rounded-full
                        ...
                        w-10 h-10 sm:w-auto sm:h-auto sm:px-6 sm:py-2 sm:rounded-lg
                ...
                >
                    {isUploading ? (
                        ...
                        <>
                            {/* Mobile: Icon only in circle */}
                            <svg className="sm:hidden h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0l4.5 4.5M12 3v13.5" />
                            </svg>
                            {/* Desktop: Text in rounded rectangle */}
